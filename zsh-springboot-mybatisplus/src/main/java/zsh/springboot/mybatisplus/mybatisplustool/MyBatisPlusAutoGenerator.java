package zsh.springboot.mybatisplus.mybatisplustool;
...
//                .setOutputDir(projectPath + "/src/main/java")
                .setOutputDir(projectPath + "/zsh-springboot-mybatisplus/src/main/java")
...
//                .setTablePrefix("t_")// 此处可以修改为您的表前缀(数组)
        ...
        PackageConfig packageConfig = new PackageConfig()
                ...
                .setParent("zsh.springboot.mybatisplus")
//                .setParent(packageName)
        ...
        // 执行器
        new com.baomidou.mybatisplus.generator.AutoGenerator()
    ...
    public static void main(String[] args) {
        ...
        String[] ds0Tables = {"share_holder"};
        String[] ds1Tables = {"share", "share_balance"};

        generateCode(
                "jdbc:mysql://106.54.211.146:3306/ds_0?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true",
                "root",
                "mima",
                "ds0", ds0Tables);
        generateCode(
                "jdbc:mysql://106.54.211.146:3306/ds_1?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true",
                "root",
                "mima",
                "ds1", ds1Tables);
    }
