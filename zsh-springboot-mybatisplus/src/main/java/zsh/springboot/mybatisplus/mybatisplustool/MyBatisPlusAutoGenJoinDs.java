...
public class MyBatisPlusAutoGenJoinDs {
...
//                .setParent(packageName)
    ...
    public static void main(String[] args) {
        ...
        String[] dsTables = {"join_main", "join_t1", "join_t2", "join_t3", "join_t4"};
        generateCode(
                "jdbc:mysql://172.22.122.23:3308/join_ds?useUnicode=true&characterEncoding=UTF-8&autoReconnect=true",
                "root",
                "aq1sw2de",
                "joinds", dsTables);
    }
